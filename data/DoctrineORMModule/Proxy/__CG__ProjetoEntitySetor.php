 ...
 */
class Setor extends \Projeto\Entity\Setor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projeto\\Entity\\Setor' . "\0" . 'id', '' . "\0" . 'Projeto\\Entity\\Setor' . "\0" . 'nome', '' . "\0" . 'Projeto\\Entity\\Setor' . "\0" . 'created_at', '' . "\0" . 'Projeto\\Entity\\Setor' . "\0" . 'data_cancelamento');
        }
