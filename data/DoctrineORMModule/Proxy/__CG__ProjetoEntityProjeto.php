...
class Projeto extends \Projeto\Entity\Projeto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'id', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'nome', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'descricao', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'slug', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'cor', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'texto', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'posicao', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'created_at', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'data_cancelamento', '' . "\0" . 'Projeto\\Entity\\Projeto' . "\0" . 'status');
        }
