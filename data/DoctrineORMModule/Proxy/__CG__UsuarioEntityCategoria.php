 ...
 */
class Categoria extends \Usuario\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Usuario\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Usuario\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'Usuario\\Entity\\Categoria' . "\0" . 'created_at', '' . "\0" . 'Usuario\\Entity\\Categoria' . "\0" . 'data_cancelamento');
        }
