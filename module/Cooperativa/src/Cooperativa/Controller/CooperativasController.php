...
use Cooperativa\Form\CooperativaForm as FormPadrao;
use Cooperativa\Validator\CooperativaValitador as ValidatorForm;
use Imagine\Image\ImageInterface;

class CooperativasController extends AbstractActionController {
    ...
    protected function getFolderView() {
        return 'cooperativa/cooperativas';
    }

    protected function getRepository() {

        return $this->getEntityManager()->getRepository("Cooperativa\Entity\Cooperativa");
    }
            ...
            if ($form->isValid()) {
                ...
                if(!empty($File['name'])){
                    ...
                    $result = $imagine->open($File['tmp_name'])
                       ->save("$path/uploads/cooperativas/". $File['name']);
                    
                    $data['imagem'] = $File['name'];
                }
                
                $File = $this->params()->fromFiles('catalogo');
