...
return array(
    'controllers' => array(
        'invokables' => array(
            'CooperativasController' => 'Cooperativa\Controller\CooperativasController',
            'RegioesController' => 'Cooperativa\Controller\RegioesController',
        ),
    ),
    'router' => array(
        'routes' => array(
            ...
            'cooperativas' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/gestao/cooperativas[/:action][/:id]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
                    'defaults' => array(
                        'controller' => 'CooperativasController',
                        'action' => 'index',
                    ),
                ),
            ),
            ...
            'regioes' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/gestao/regioes[/:action][/:id]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
                    'defaults' => array(
                        'controller' => 'RegioesController',
                        'action' => 'index',
                    ),
                ),
            ),
