...
use Usuario\Form\CategoriaForm;
use Usuario\Validator\CategoriaValitador as ValidatorForm;
...
class CategoriasController extends AbstractActionController {
    ...
    protected function getRepository() {
        ...
        return $this->getEntityManager()->getRepository("Usuario\Entity\Categoria");
    }
