...
use Marketing\Entity\Depoimento as Entity;
...
class Depoimento extends EntityRepository {
    ...
    public function listagemHome() {
        ...
        $stmt = "SELECT q FROM $this->_entityName q Where "
                . "q.data_cancelamento IS NULL And q.destaque = 1 ORDER BY q.id DESC";
        
        return $this->_em->createQuery($stmt)->setMaxResults(3)->execute();
