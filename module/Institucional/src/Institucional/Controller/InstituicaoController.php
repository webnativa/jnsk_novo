...
use Institucional\Form\InstituicaoForm as FormPadrao;
use Institucional\Validator\InstituicaoValitador as ValidatorForm;
...
class InstituicaoController extends AbstractActionController {
    ...
    protected function getFolderView() {
        return 'institucional/instituicao';
    }

    protected function getRepository() {

        return $this->getEntityManager()->getRepository("Institucional\Entity\Instituicao");
    }
    ...
    public function editarAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $this->getRepository()->save($form->getData());
                $this->flashMessenger()->addSuccessMessage(Entity::getVerboseName() . " editada(a) com sucesso!");
