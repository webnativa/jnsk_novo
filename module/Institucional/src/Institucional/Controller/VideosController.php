...
use Institucional\Form\VideoForm as FormPadrao;
use Institucional\Validator\VideoValitador as ValidatorForm;
...
class VideosController extends AbstractActionController {
    ...
    protected function getFolderView() {
        return 'institucional/videos';
    }

    protected function getRepository() {

        return $this->getEntityManager()->getRepository("Institucional\Entity\Video");
    }
            ...
            if ($form->isValid()) {
                ...
                if(!empty($File['name'])){
                    ...
                    $result = $imagine->open($File['tmp_name'])
                       ->save("$path/uploads/videos/". $File['name']);
